module github.com/Giovani-RodriguesS/Serverless-Aws/project/src/error_handler

go 1.23.4

require (
	github.com/Giovani-RodriguesS/Serverless-Aws/project/src/pkg v0.0.0-20250829001335-d91a7c281626
